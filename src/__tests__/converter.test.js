...
test('PPT2PDF converter test', async (t) => {
    await t.test('It should generate the converter', () => {
        ...
        assert.strictEqual(converter.oldFile.path, 'test/OPW 733 Tienduizend redenen.ppt');
    });
    ...
    await t.test('It should generate the converter', () => {
        ...
        assert.strictEqual(result.file.path, 'test/OPW 733 Tienduizend redenen.ppt');
        assert.strictEqual(converter.pdf, 'output/OPW 733 Tienduizend redenen.pdf');
